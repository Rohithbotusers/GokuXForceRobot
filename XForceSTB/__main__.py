...
buttons = [
    ...
    [
      InlineKeyboardButton(
           text="Fun chat", url="https://t.me/beybladefunchatt"
        ),
    ],
]
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am the world best group managemed bot!](https://telegra.ph/file/87affb170718b0dc07c4c.mp4)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
